...
define("oscarparamo/pods/index/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "yUHx2d6V", "block": "{\"statements\":[[\"block\",[\"paper-card\"],null,[[\"title\",\"class\"],[\"Home\",\"home\"]],4],[\"text\",\"\\n\"],[\"block\",[\"paper-card\"],null,[[\"title\",\"class\"],[\"Follow Me\",\"follow\"]],3]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"span\",[]],[\"flush-element\"],[\"text\",\"Email\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"span\",[]],[\"flush-element\"],[\"text\",\"LinkedIn\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"span\",[]],[\"flush-element\"],[\"text\",\"GitHub\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Want to keep in touch? Then follow up with me at any of the places below!\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"icon-set\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"icon-badge\"],null,[[\"iconSet\",\"iconClass\",\"url\"],[\"op\",\"op-github\",\"https://github.com/oparamo\"]],2],[\"block\",[\"icon-badge\"],null,[[\"iconSet\",\"iconClass\",\"url\"],[\"op\",\"op-linkedin\",\"https://www.linkedin.com/in/oparamo\"]],1],[\"block\",[\"icon-badge\"],null,[[\"iconSet\",\"iconClass\",\"url\"],[\"op\",\"op-envelope\",\"mailto:oscar.paramo@me.com\"]],0],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Welcome to my personal website and development playground! I built this website so I could have a place to share\\n  information about myself and anything I've worked on. I plan to link or host any future projects here, so check in\\n  whenever you'd like.\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"I had a lot of fun building this website and learned a lot in the process, so the first thing I'll be sharing here is\\n  my website's source code! If you're interested, there's a link at the bottom that'll take you to my GitHub page.\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "oscarparamo/pods/index/template.hbs" } });
});
